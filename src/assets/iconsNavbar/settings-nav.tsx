...
const SvgComponent = ({ fill = '#000', ...props }: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg viewBox="-0.5 0 25 25" height="20" width="20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
      <path d="M12 7.82001H22" stroke={fill} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
      <path d="M2 7.82001H4" stroke={fill} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
      <path d="M20 16.82H22" stroke={fill} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
      <path d="M2 16.82H12" stroke={fill} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
      <path
