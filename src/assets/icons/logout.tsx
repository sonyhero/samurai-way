...
const SvgComponent = ({ fill = '#fff', ...props }: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16" fill={fill} ref={ref} {...props}>
    <g fill="#inherit">
